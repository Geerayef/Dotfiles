...
alias dotu="dot add .config/{nvim,vim,neovide,moxide,mdt,glow,emacs,tofi,alacritty,wezterm,foot,kitty,hypr,fish,bash,zsh,firefoxcss,nnn,bat,btop,mako,fontconfig,starship,tmux,vimiumc,zathura}/ .local/bin/ .zshenv"
alias dota="dot add"

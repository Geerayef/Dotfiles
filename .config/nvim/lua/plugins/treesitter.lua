      ...
      ts.setup({
        ...
        textobjects = {
          select = {
            enable = true,
            lookahead = true,
            keymaps = { ["fo"] = "@function.outer", ["fi"] = "@function.inner", ["co"] = "@class.outer", ["ci"] = "@class.inner" }
          },
          move = {
            enable = true,
            set_jumps = true,
          ...
          swap = { enable = true, swap_next = { ["<leader>snp"] = "@parameter.inner" }, swap_previous = { ["<leader>spp"] = "@parameter.inner" } },
          lsp_interop = {
            enable = true,
            border = "single",

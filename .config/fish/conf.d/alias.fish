...
alias dotu="dot add .config/{nvim,vim,neovide,moxide,emacs,tofi,alacritty,wezterm,foot,kitty,hypr,fish,bash,zsh,nnn,bat,btop,mako,fontconfig,starship,tmux,vimiumc,zathura}/ .local/bin/ .zshenv"
alias dota="dot add"

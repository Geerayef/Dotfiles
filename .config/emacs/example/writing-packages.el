;;;; writing-packages.el --- Packages used for writing  -*- lexical-binding: t; -*-
;;; Commentary:
;;; Code:
...
;; Install the auctex-latexmk package when the latex and latexmk executable are found.

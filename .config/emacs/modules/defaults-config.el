;;;; defaults-config.el --- Default settings (TODO: Move to init maybe?) -*- lexical-binding: t; -*-
...
;; Scroll eshell buffer to the bottom on input, but only in "this" window.
(customize-set-variable 'eshell-scroll-to-bottom-on-input 'this)

;; Pop up dedicated buffers in a different window.
(customize-set-variable 'switch-to-buffer-in-dedicated-window 'pop)
;; Treat manual buffer switching (C-x b for example) the same as programmatic buffer switching.
...
;; open man pages in their own window, and switch to that window to facilitate reading and closing the man page.

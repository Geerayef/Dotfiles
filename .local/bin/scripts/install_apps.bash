...
main() {
  ...
  local app="hyprland hypridle hyprlock hyprpaper hyprlang wezterm foot fish starship neovim python-pynvim fd ripgrep fzf bat eza git curl wget clang cmake brightnessctl playerctl pipewire wireplumber handlr-regex pandoc-cli md-tui glow syncthing rclone grim slurp wl-clipboard cliphist tlp tlp_rdw nwg-look"
